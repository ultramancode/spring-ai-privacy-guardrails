...
final class PrivacyDemoToolLoop {
    ...
    private final PrivacySecurityChatClientConfigurer privacySecurityConfigurer;
    ...
    PrivacyDemoToolLoop(
        ...
        this.privacySecurityConfigurer = privacySecurityConfigurer;
    ...
    private Attempt execute(String input, PrivacyDemoLocale locale) {
        ...
        this.privacySecurityConfigurer.configure(builder);
