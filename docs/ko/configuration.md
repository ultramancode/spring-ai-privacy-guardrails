...
<!-- i18n-source-sha256: b5ef210f28ea5edd827d99b9acb2877e35c8b01664c0dd5e17514e1e81bbe64e -->
...
한 번의 분석에서 반환할 수 있는 span은 최대 100,000개
(`PiiAnalyzer.MAX_RESULT_SPANS`)입니다. 라이브러리는 분석기가 결과를 반환하기 전에
내부에서 사용하는 메모리까지 제한하지 않으므로, 사용자 정의 분석기는 자체 메모리
사용량도 적절히 제한해야 합니다.
